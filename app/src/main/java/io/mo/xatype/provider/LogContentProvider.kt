        ...
        when (method) {
            ...
            METHOD_GET_CONFIG -> {
                ...
                if (ctx != null) {
                    ...
                    result.putInt(io.mo.xatype.config.ConfigManager.KEY_CORNER_MODE, sp.getInt(io.mo.xatype.config.ConfigManager.KEY_CORNER_MODE, 0))
                    result.putInt(io.mo.xatype.config.ConfigManager.KEY_OPACITY, sp.getInt(io.mo.xatype.config.ConfigManager.KEY_OPACITY, 100))
